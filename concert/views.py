...
def songs(request):
    songs = req.get("http://songs-sn-labs-santi252565.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/song").json()
    return render(request, "songs.html", {"songs": songs})


def photos(request):
    photos = req.get("http://pictures-sn-labs-santi252565.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/picture").json()
